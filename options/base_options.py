...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default=r'E:\ZTD\JL1', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        ='./checkpoints', help='models are saved here')
        # model parameters
        ...
        parser.add_argument('--netG', type=str, default='ResnetGenerator_swin', choices=['resnet_9blocks', 'resnet_6blocks', 'unet_256', 'unet_128', 'stylegan2', 'smallstylegan2', 'resnet_cat'], help='specify generator architecture')
